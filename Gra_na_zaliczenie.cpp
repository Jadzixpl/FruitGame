...
sf::Texture jablko;
extern auto teksturaJablka = jablko.loadFromFile("apyl.png");

sf::Texture gruszka;
extern auto teksturaGruszki = gruszka.loadFromFile("gruszka.png");

sf::Texture banan;
extern auto teksturaBanana = banan.loadFromFile("banan.png");

sf::Texture winogrona;
extern auto teksturaWinogrona = winogrona.loadFromFile("winogrona.png");
